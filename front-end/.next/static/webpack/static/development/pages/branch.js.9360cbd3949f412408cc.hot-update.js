webpackHotUpdate("static\\development\\pages\\branch.js",{
...
})(["display:flex;justify-content:space-between;align-items:center;position:relative;height:53px;padding:0 16px 0 0;background-color:white;z-index:5;@media screen and (max-width:992px){background-color:#005874;height:84px;padding:0 16px;}a{font-family:sans-serif;text-decoration:none;}"]);
...
})(["padding:50px 0 0 0;box-sizing:border-box;height:100vh;", ";position:fixed;top:0;left:0;display:flex;flex-direction:column;p{display:flex;align-items:center;border:black solid 1px;padding:0 5px;height:40px;font-family:sans-serif;}@keyframes appear{0%{opacity:0;}100%{opacity:1;}}@keyframes slideIn{0%{transform:translateX(-2%);}100%{transform:translateX(0);}}@keyframes shrink{0%{width:95%;}100%{width:90%;}}"], function (props) {
  return props.primary && "background-color: ".concat(props.theme.colorPrimary);
});
...
//# sourceMappingURL=branch.js.9360cbd3949f412408cc.hot-update.js.map