...
})(["display:flex;justify-content:space-between;align-items:center;position:relative;height:53px;padding:0 16px 0 0;", ";z-index:5;@media screen and (max-width:992px){background-color:#005874;height:84px;padding:0 16px;}a{font-family:sans-serif;text-decoration:none;}"], function (props) {
...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Header, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(HeaderStyle, {
        primary: true
...
//# sourceMappingURL=branch.js.2d3db5be9ecc056632ac.hot-update.js.map