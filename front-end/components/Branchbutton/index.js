      ...
      <div>
        ...
        <MenuDiv style={{...styles.menu}}>
          <BranchesDiv>
            ...
            {this.state.branches.map((item, key) => {
              return (
                <Link
                  ...
                  <BranchLink
                    style={{...{backgroundColor: this.props.title == item.acf.name ? 'rgba(238, 238, 238, 0.97)' : 'white'}}}>
                    <svg fill={colors[key]} width="16" height="16" xmlns='http://www.w3.org/2000/svg' id='Layer_1' viewBox='0 0 512 512'>
            ...
            <BranchLink href="https://instagram.com"><div className="pre"></div>Instagram</BranchLink>
